...
export const albums: Album[] = [
  {
    ...
    description: [
      "幸福的末班車 / The Last Train of Happiness becomes the core 15th-anniversary album era for TRASH, placing the band’s accumulated history beside a new official chapter of songs, stage memory, and recognition.",
    ],
    credits: [],
  ...
  },
  {
    ...
    coverTodo: "Official cover asset integrated.",
    summary: "Holy Trip! expands TRASH’s catalog with a full-length album chapter that sits between the band’s earlier records and the later 15th-anniversary era.",
    description: ["Holy Trip! represents a major album phase in the TRASH archive, giving the discography another full-length marker before the band’s later arena-scale chapter."],
    credits: [],
  ...
  },
  {
    ...
    coverTodo: "Official cover asset integrated.",
    summary: "Never Die is a four-track EP in the TRASH release archive, presented as a focused release chapter within the band’s Warner Music phase.",
    description: ["Never Die marks a compact release chapter in the band’s discography, keeping the archive focused on verified release data while full credits remain pending."],
    credits: [],
  ...
  },
  {
    ...
    coverTodo: "Official cover asset integrated.",
    summary: "11:11 marks another major creative phase in the band’s archive, expanding the discography before the later Warner Music and arena chapters.",
    description: ["11:11 marks another major creative phase in the band’s archive, with the public page limited to confirmed release-level information until full credits are approved."],
    credits: [],
  ...
  },
  {
    ...
    coverTodo: "Official cover asset integrated.",
    summary: "歸零 / Reset becomes an important early release in the TRASH archive and connects the band to Golden Melody Awards Best Band nomination recognition.",
    description: ["歸零 / Reset is a key early release in the TRASH archive, bridging the band’s independent momentum with wider award recognition context."],
    credits: [],
  ...
  },
  {
    ...
    coverTodo: "Official cover asset integrated.",
    summary: "TRASH releases its self-titled first album in 2012, anchoring the beginning of the band’s official release archive and Gongliao Ocean Music Festival recognition phase.",
    description: ["The self-titled first album belongs to the band’s early independent archive, connecting the 2012 release chapter with the Gongliao Ocean Music Festival recognition phase."],
    credits: [],
