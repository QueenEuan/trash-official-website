...
export const shows: Show[] = [
  {
    ...
    description: "A 15th-anniversary arena milestone marking TRASH’s first Taipei Arena chapter.",
  ...
  },
  {
    ...
    description: "The Kaohsiung arena chapter extending The Last Train of Happiness into the south.",
