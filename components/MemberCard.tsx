...
export function MemberCard({ member, locale = defaultLocale }: { member: Member; locale?: Locale }) {
  return (
    <LocalizedLink href={`/members/${member.slug}`} locale={locale} className="group relative block overflow-hidden border border-white/10 bg-black transition hover:-translate-y-1 hover:border-gold/70">
