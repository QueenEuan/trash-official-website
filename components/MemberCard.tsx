...
export function MemberCard({ member }: { member: Member }) {
  return (
    <LocalizedLink href={`/members/${member.slug}`} className="group relative block overflow-hidden border border-white/10 bg-black transition hover:-translate-y-1 hover:border-gold/70">
